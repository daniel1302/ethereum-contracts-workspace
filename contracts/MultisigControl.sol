...
contract MultisigControl is IMultisigControl {
    ...
    function set_threshold(uint16 new_threshold, uint256 nonce, bytes calldata signatures) external override {
    ...
    function add_signer(address new_signer, uint256 nonce, bytes calldata signatures) external override {
    ...
    function remove_signer(address old_signer, uint256 nonce, bytes calldata signatures) external override {
